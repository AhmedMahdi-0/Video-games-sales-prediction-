...
DTR2 =DecisionTreeRegressor(min_samples_split=3)
DTR3 =DecisionTreeRegressor(min_samples_split=15)
DTR4 =DecisionTreeRegressor(min_samples_split=30)
DTR5 =DecisionTreeRegressor(min_samples_split=35)
...
print ("\nAccuracy in the training data with Decision Tree Regression model After tuning with min_samples_split=3 : ", Accuracy2*100, "%")

accuracy2 = DTR2.score(X_test, y_test)
print ("Accuracy in the test data with Decision Tree Regression model After tuning with min_samples_split=3 : ", accuracy2*100, "%")
##########################
Accuracy3 = DTR3.score(X_train, y_train)
print ("\nAccuracy in the training data with Decision Tree Regression model After tuning with min_samples_split=15 : ", Accuracy3*100, "%")

accuracy3 = DTR3.score(X_test, y_test)
print ("Accuracy in the test data with Decision Tree Regression model After tuning with min_samples_split=15 : ", accuracy3*100, "%")
##########################
Accuracy4 = DTR4.score(X_train, y_train)
print ("\nAccuracy in the training data with Decision Tree Regression model After tuning with min_samples_split=30 : ", Accuracy4*100, "%")

accuracy4 = DTR4.score(X_test, y_test)
print ("Accuracy in the test data with Decision Tree Regression model After tuning with min_samples_split=30 : ", accuracy4*100, "%")
##########################
Accuracy5 = DTR5.score(X_train, y_train)
print ("\nAccuracy in the training data with Decision Tree Regression model After tuning with min_samples_split=35 : ", Accuracy5*100, "%")

accuracy5 = DTR5.score(X_test, y_test)
print ("Accuracy in the test data with Decision Tree Regression model After tuning with min_samples_split=35 : ", accuracy5*100, "%")
##########################
